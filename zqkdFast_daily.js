...
async function GetFightList(userIdx) {
    ...
    let body = `app_version=2.5.5&channel=c6004&${userCk}&device_model=RedmiNote5&device_brand=XIAOMI&resolution=1080*2160&os_version=29&is_wxaccount=1&active_channel=c6004&access=wifi&v=${rndtime}&request_time=${rndtimeInS}`
...
async function PkFightGame(userIdx,pk_uid) {
    ...
    let userCk = userCookieArr[userIdx]
    let uid = userCk.match(/uid=(\w+)/)[1]
    let body = `app_version=2.5.5&channel=c6004&${userCk}&device_model=RedmiNote5&device_brand=XIAOMI&resolution=1080*2160&os_version=29&is_wxaccount=1&active_channel=c6004&access=wifi&v=${rndtime}&request_time=${rndtimeInS}&pk_uid=${pk_uid}`
...
async function GetRotaryInfo(userIdx) {
    ...
    let userCk = userCookieArr[userIdx]
    let uid = userCk.match(/uid=(\w+)/)[1]
    let body = `${userCk}&app_version=2.5.5&channel=c6004&device_model=RedmiNote5&device_brand=XIAOMI&resolution=1080*2160&os_version=29&is_wxaccount=1&active_channel=c6004&access=wifi&v=${rndtimeInMs}`
